...
const SIDEBAR_SECTIONS = [
    ...
    { sectionId: 'workflow',  label: 'Workflow',     Icon: Activity     },
]
            ...
            <header className="bg-white border-b border-slate-200 sticky top-0 z-40 shadow-sm">
                <div className="max-w-screen-2xl mx-auto px-6 h-14 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {/* Refresh */}
                        <NotificationsBell role="department_head" />
                ...
                <main className="flex-1 px-6 py-6">
                    ...
                    {isLoading && (
                        <div className="mb-6 flex items-center gap-3 bg-sky-50 border border-sky-200 rounded-2xl px-5 py-3">
                            ...
                            <p className="text-sm font-semibold text-violet-700">Loading department data...</p>
                        </div>
                    )}
                    ...
                    <DeptSection
                        ...
                        subtitle="Record vitals, diagnose patients, view billing"
                    >
                        <WorkflowPanel role="department_head" />
                    </DeptSection>


                </main>
            </div>
            <ChatBox role="department_head" />
        </div>
    )
}
